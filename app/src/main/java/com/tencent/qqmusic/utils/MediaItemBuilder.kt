...
object MediaItemBuilder {
    ...
    private const val EXTERNAL_EXTRA_PREFIX = "com.tencent.qqmusic.external."
    ...
    fun buildForExternalController(context: Context, song: Song): MediaItem {
        ...
        return com.tencent.qqmusic.data.diagnostics.PerformanceMetrics.time(
            com.tencent.qqmusic.data.diagnostics.PerformanceMetrics.Timings.MEDIASESSION_ITEM_BUILD
        ) {
            MediaItem.Builder()
                .setMediaId(song.id)
                .setUri(playbackUri(song))
