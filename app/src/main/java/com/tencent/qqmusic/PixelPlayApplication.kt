...
import com.tencent.qqmusic.data.diagnostics.AdvancedPerformanceDiagnosticsController
...
import com.tencent.qqmusic.presentation.viewmodel.LibraryStateHolder
import com.tencent.qqmusic.presentation.viewmodel.ThemeStateHolder
...
import com.tencent.qqmusic.utils.MediaMetadataRetrieverPool
...
class PixelPlayApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var telegramCoilFetcherFactory: dagger.Lazy<com.tencent.qqmusic.data.image.TelegramCoilFetcher.Factory>

    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.tencent.qqmusic.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.tencent.qqmusic.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.tencent.qqmusic.data.image.LocalArtworkCoilFetcher.Factory>
