package com.tencent.qqmusic.di
...
import com.tencent.qqmusic.PixelPlayApplication
import com.tencent.qqmusic.data.database.AlbumArtThemeDao
import com.tencent.qqmusic.data.database.EngagementDao
import com.tencent.qqmusic.data.database.FavoritesDao
import com.tencent.qqmusic.data.database.GDriveDao
import com.tencent.qqmusic.data.database.LyricsDao
import com.tencent.qqmusic.data.database.AiCacheDao
import com.tencent.qqmusic.data.database.AiUsageDao
import com.tencent.qqmusic.data.database.LocalPlaylistDao
import com.tencent.qqmusic.data.database.MusicDao
import com.tencent.qqmusic.data.database.PixelPlayDatabase
import com.tencent.qqmusic.data.database.SearchHistoryDao
import com.tencent.qqmusic.data.database.TransitionDao
import com.tencent.qqmusic.data.preferences.UserPreferencesRepository
import com.tencent.qqmusic.data.preferences.PlaylistPreferencesRepository
import com.tencent.qqmusic.data.preferences.dataStore
import com.tencent.qqmusic.data.media.SongMetadataEditor
import com.tencent.qqmusic.data.network.deezer.DeezerApiService
import com.tencent.qqmusic.data.network.netease.NeteaseApiService
import com.tencent.qqmusic.data.network.lyrics.LrcLibApiService
import com.tencent.qqmusic.data.repository.ArtistImageRepository
import com.tencent.qqmusic.data.repository.LyricsRepository
import com.tencent.qqmusic.data.repository.LyricsRepositoryImpl
import com.tencent.qqmusic.data.repository.MediaStoreSongRepository
import com.tencent.qqmusic.data.repository.MusicRepository
import com.tencent.qqmusic.data.repository.MusicRepositoryImpl
import com.tencent.qqmusic.data.repository.SongRepository
import com.tencent.qqmusic.data.repository.TransitionRepository
import com.tencent.qqmusic.data.repository.TransitionRepositoryImpl
import com.tencent.qqmusic.data.repository.FolderTreeBuilder
...
object AppModule {
    ...
    fun provideSessionToken(@ApplicationContext context: Context): androidx.media3.session.SessionToken {
        return androidx.media3.session.SessionToken(
            context,
            android.content.ComponentName(context, com.tencent.qqmusic.data.service.MusicService::class.java)
        )
    }
    ...
    @Singleton
    @Provides
    fun provideQqMusicDao(database: PixelPlayDatabase): com.tencent.qqmusic.data.database.QqMusicDao {
        return database.qqmusicDao()
    }

    @Singleton
    @Provides
    fun provideNavidromeDao(database: PixelPlayDatabase): com.tencent.qqmusic.data.database.NavidromeDao {
    ...
    @Singleton
    @Provides
    fun provideJellyfinDao(database: PixelPlayDatabase): com.tencent.qqmusic.data.database.JellyfinDao {
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.tencent.qqmusic.data.observer.MediaStoreObserver,
    ...
    @Singleton
    @Provides
    fun provideTelegramDao(database: PixelPlayDatabase): com.tencent.qqmusic.data.database.TelegramDao {
        return database.telegramDao()
    }

    @Singleton
    @Provides
    fun provideNeteaseDao(database: PixelPlayDatabase): com.tencent.qqmusic.data.database.NeteaseDao {
    ...
    fun provideMusicRepository(
        ...
        telegramDao: com.tencent.qqmusic.data.database.TelegramDao,
        telegramCacheManager: Lazy<com.tencent.qqmusic.data.telegram.TelegramCacheManager>,
        telegramRepository: Lazy<com.tencent.qqmusic.data.telegram.TelegramRepository>,
