...
import com.tencent.qqmusic.shared.WearLyrics
...
class WearStatePublisher @Inject constructor(
    ...
    private fun resolveArtworkBytesForWear(playerInfo: PlayerInfo): ByteArray? {
        ...
        if (!uriString.isNullOrBlank()) {
            ...
            when {
                com.tencent.qqmusic.utils.LocalArtworkUri.isLocalArtworkUri(uriString) ||
                    scheme == "content" ||
                    scheme == "file" ||
    ...
    private fun com.tencent.qqmusic.data.model.Lyrics.toWearLyrics(
