package com.tencent.qqmusic.data.service
...
import com.tencent.qqmusic.data.diagnostics.PerformanceMetrics
import com.tencent.qqmusic.data.model.PlayerInfo
import com.tencent.qqmusic.data.model.PlaybackQueueItemSnapshot
import com.tencent.qqmusic.data.model.PlaybackQueueSnapshot
import com.tencent.qqmusic.data.preferences.EqualizerPreferencesRepository
...
import com.tencent.qqmusic.data.service.player.TransitionController
import com.tencent.qqmusic.ui.glancewidget.PlayerActions
import com.tencent.qqmusic.utils.AlbumArtUtils
...
import com.tencent.qqmusic.data.equalizer.EqualizerManager
import com.tencent.qqmusic.data.model.WidgetThemeColors
import com.tencent.qqmusic.data.preferences.AlbumArtColorAccuracy
import com.tencent.qqmusic.data.preferences.AlbumArtPaletteStyle
import com.tencent.qqmusic.presentation.viewmodel.ColorSchemeProcessor
import androidx.compose.ui.graphics.toArgb
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.tencent.qqmusic.data.preferences.ThemePreference
import com.tencent.qqmusic.data.service.auto.AutoMediaBrowseTree
import com.tencent.qqmusic.data.service.wear.buildWearThemePalette
import com.tencent.qqmusic.data.service.wear.WearStatePublisher
import com.tencent.qqmusic.presentation.viewmodel.ColorSchemePair
import com.tencent.qqmusic.shared.WearIntents
import com.tencent.qqmusic.utils.ArtworkTransportSanitizer
import com.tencent.qqmusic.utils.MediaItemBuilder
import com.tencent.qqmusic.data.navidrome.NavidromeRepository
import com.tencent.qqmusic.di.AppScope
import com.tencent.qqmusic.presentation.viewmodel.ListeningStatsTracker
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var replayGainManager: com.tencent.qqmusic.data.media.ReplayGainManager
    @Inject
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.tencent.qqmusic.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.tencent.qqmusic.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.tencent.qqmusic"
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.tencent.qqmusic.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.tencent.qqmusic.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun resolveWearLyrics(mediaId: String?): com.tencent.qqmusic.data.model.Lyrics? {
    ...
    public suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.tencent.qqmusic.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
