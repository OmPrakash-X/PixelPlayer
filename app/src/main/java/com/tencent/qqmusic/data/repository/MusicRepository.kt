...
interface MusicRepository {
     ...
     */
    fun getPaginatedSongs(sortOption: com.tencent.qqmusic.data.model.SortOption, storageFilter: com.tencent.qqmusic.data.model.StorageFilter): Flow<PagingData<Song>>

    /**
     * Returns paginated albums for efficient display in library tabs.
     */
    fun getPaginatedAlbums(
        sortOption: com.tencent.qqmusic.data.model.SortOption,
        storageFilter: com.tencent.qqmusic.data.model.StorageFilter = com.tencent.qqmusic.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.tencent.qqmusic.data.model.SortOption = com.tencent.qqmusic.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.tencent.qqmusic.data.model.StorageFilter = com.tencent.qqmusic.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.tencent.qqmusic.data.model.SortOption = com.tencent.qqmusic.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.tencent.qqmusic.data.model.StorageFilter = com.tencent.qqmusic.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.tencent.qqmusic.data.model.SortOption = com.tencent.qqmusic.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.tencent.qqmusic.data.model.StorageFilter = com.tencent.qqmusic.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.tencent.qqmusic.data.model.SortOption = com.tencent.qqmusic.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.tencent.qqmusic.data.model.StorageFilter = com.tencent.qqmusic.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.tencent.qqmusic.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.tencent.qqmusic.data.model.StorageFilter = com.tencent.qqmusic.data.model.StorageFilter.ALL
    ): Flow<List<com.tencent.qqmusic.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.tencent.qqmusic.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.tencent.qqmusic.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.tencent.qqmusic.data.database.TelegramTopicEntity>
    fun getAllTelegramTopics(): Flow<List<com.tencent.qqmusic.data.database.TelegramTopicEntity>>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.tencent.qqmusic.data.telegram.TelegramRepository
