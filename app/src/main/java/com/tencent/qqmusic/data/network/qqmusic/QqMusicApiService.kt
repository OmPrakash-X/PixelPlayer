package com.tencent.qqmusic.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.tencent.qqmusic.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.tencent.qqmusic.data.remote.qqmusic.QQSignGenerator(context)
        ))
