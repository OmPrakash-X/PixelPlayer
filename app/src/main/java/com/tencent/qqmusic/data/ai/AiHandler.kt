package com.tencent.qqmusic.data.ai
...
import com.tencent.qqmusic.data.database.AiCacheEntity
...
class AiHandler @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        suspend fun callWithModel(model: String): String {
            return try {
                ...
                throw com.tencent.qqmusic.data.ai.provider.AiProviderSupport.createException(
        ...
        return try {
            ...
            val failure = com.tencent.qqmusic.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.tencent.qqmusic.data.ai.provider.AiClient,
        failure: com.tencent.qqmusic.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.tencent.qqmusic.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.tencent.qqmusic.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.tencent.qqmusic.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
