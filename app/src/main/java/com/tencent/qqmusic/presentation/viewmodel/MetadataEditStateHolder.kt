...
import com.tencent.qqmusic.data.media.ImageCacheManager
import com.tencent.qqmusic.data.media.MetadataEditError
...
import com.tencent.qqmusic.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.tencent.qqmusic.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
