...
import com.tencent.qqmusic.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.tencent.qqmusic.presentation.viewmodel.StablePlayerState>
    ) {
