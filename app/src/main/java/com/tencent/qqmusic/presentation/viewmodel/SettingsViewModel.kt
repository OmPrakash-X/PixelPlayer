...
import com.tencent.qqmusic.data.backup.BackupManager
...
import com.tencent.qqmusic.data.backup.model.RestoreResult
import com.tencent.qqmusic.data.backup.model.ValidationError
...
import com.tencent.qqmusic.data.database.AiUsageEntity
...
import com.tencent.qqmusic.data.ai.GeminiModel
import com.tencent.qqmusic.data.ai.provider.AiClientFactory
import com.tencent.qqmusic.data.ai.provider.AiProvider
import com.tencent.qqmusic.data.preferences.LaunchTab
import com.tencent.qqmusic.data.model.Song
import com.tencent.qqmusic.data.service.player.HiFiCapabilityChecker
...
class SettingsViewModel @Inject constructor(
    ...
    private val geminiModelService: com.tencent.qqmusic.data.ai.GeminiModelService,
            ...
            try {
                ...
                val models = if (provider == AiProvider.GEMINI) {
                    ...
                    aiClient.getAvailableModels(apiKey)
                        ...
                        .distinct()
                        .map { com.tencent.qqmusic.data.ai.GeminiModel(it, formatModelDisplayName(it)) }
                }
    ...
    fun setAlbumArtCacheLimitMb(limitMb: Int) {
        viewModelScope.launch {
            ...
            com.tencent.qqmusic.utils.AlbumArtCacheManager.configuredCacheLimitMb = limitMb.toLong()
        }
    }
