...
import com.tencent.qqmusic.data.DailyMixManager
import com.tencent.qqmusic.data.model.Playlist
import com.tencent.qqmusic.data.model.SmartPlaylistRule
import com.tencent.qqmusic.data.model.Song
import com.tencent.qqmusic.data.model.SortOption
import com.tencent.qqmusic.data.playlist.M3uManager
...
import com.tencent.qqmusic.data.preferences.TelegramTopicDisplayMode
import com.tencent.qqmusic.data.ai.AiPlaylistGenerator
...
class PlaylistViewModel @Inject constructor(
    ...
    private fun findFolder(
        targetPath: String,
        folders: List<com.tencent.qqmusic.data.model.MusicFolder>
    ): com.tencent.qqmusic.data.model.MusicFolder? {
        val queue: ArrayDeque<com.tencent.qqmusic.data.model.MusicFolder> = ArrayDeque(folders)
    ...
    private fun com.tencent.qqmusic.data.model.MusicFolder.collectAllSongs(): List<Song> {
    ...
    private fun sortPlaylistsList(
        playlists: List<com.tencent.qqmusic.data.model.Playlist>,
        sortOption: SortOption
    ): List<com.tencent.qqmusic.data.model.Playlist> {
        return when (sortOption) {
            SortOption.PlaylistNameAZ -> playlists.sortedWith(
                compareBy<com.tencent.qqmusic.data.model.Playlist> { it.name.lowercase() }
                    .thenByDescending { it.lastModified }
                    .thenBy { it.id }
            )
            SortOption.PlaylistNameZA -> playlists.sortedWith(
                compareByDescending<com.tencent.qqmusic.data.model.Playlist> { it.name.lowercase() }
                    .thenByDescending { it.lastModified }
                    .thenBy { it.id }
            )
            SortOption.PlaylistDateCreated -> playlists.sortedWith(
                compareByDescending<com.tencent.qqmusic.data.model.Playlist> { it.lastModified }
                    .thenBy { it.name.lowercase() }
                    .thenBy { it.id }
            )
            SortOption.PlaylistDateCreatedAsc -> playlists.sortedWith(
                compareBy<com.tencent.qqmusic.data.model.Playlist> { it.lastModified }
                    .thenBy { it.name.lowercase() }
                    .thenBy { it.id }
            )
