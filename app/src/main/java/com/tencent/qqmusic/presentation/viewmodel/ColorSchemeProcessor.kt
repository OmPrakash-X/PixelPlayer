...
import com.tencent.qqmusic.data.database.AlbumArtThemeEntity
import com.tencent.qqmusic.data.database.StoredColorSchemeValues
import com.tencent.qqmusic.data.database.toComposeColor
import com.tencent.qqmusic.utils.LocalArtworkUri
import com.tencent.qqmusic.ui.theme.clearExtractedColorCache
import com.tencent.qqmusic.ui.theme.extractSeedColor
import com.tencent.qqmusic.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.tencent.qqmusic.ui.theme.ColorExtractionConfig(
