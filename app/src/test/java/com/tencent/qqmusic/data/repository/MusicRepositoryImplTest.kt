...
import com.tencent.qqmusic.data.database.SongEntity // Necesario para datos de prueba
import com.tencent.qqmusic.data.database.AlbumEntity
import com.tencent.qqmusic.data.database.ArtistEntity
import com.tencent.qqmusic.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.tencent.qqmusic.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.tencent.qqmusic.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.tencent.qqmusic.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.tencent.qqmusic.data.telegram.TelegramRepository> = mockk()
