...
-keepclassmembers class com.tencent.qqmusic.data.model.** { *; }
-keepclassmembers class com.tencent.qqmusic.domain.model.** { *; }

-keepattributes Signature, InnerClasses, EnclosingMethod, AnnotationDefault, *Annotation*

# Cast framework classes loaded via manifest/reflective entry points.
-keep class com.tencent.qqmusic.data.service.cast.CastOptionsProvider { *; }
...
-keep class com.tencent.qqmusic.data.preferences.PreferenceBackupEntry { *; }
-keep class com.tencent.qqmusic.data.backup.model.** { *; }
-keep class com.tencent.qqmusic.data.backup.module.** { *; }
# Backup payload entities are part of the persisted .pxpl contract.
-keep class com.tencent.qqmusic.data.database.FavoritesEntity { *; }
-keep class com.tencent.qqmusic.data.database.SongEngagementEntity { *; }
-keep class com.tencent.qqmusic.data.database.LyricsEntity { *; }
-keep class com.tencent.qqmusic.data.database.SearchHistoryEntity { *; }
-keep class com.tencent.qqmusic.data.database.TransitionRuleEntity { *; }
...
-keep class com.tencent.qqmusic.data.telegram.TelegramStreamProxy { *; }
